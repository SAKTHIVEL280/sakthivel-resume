...
class InfiniteGridMenu {
  ...
  constructor(canvas: HTMLCanvasElement, items: InfiniteMenuItem[], onActiveItemChange?: (index: number) => void, onMovementChange?: (isMoving: boolean) => void, onInit?: ((menu: InfiniteGridMenu) => void) | null) {
    this.canvas = canvas;
    this.items = items || [];
  ...
  #init(onInit?: ((menu: InfiniteGridMenu) => void) | null) {
    ...
    this.discVAO = makeVertexArray(
      this.gl,
      [
        [makeBuffer(this.gl, this.discBuffers.vertices, this.gl.STATIC_DRAW), this.discLocations.aModelPosition, 3],
