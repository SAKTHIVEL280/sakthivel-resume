...
interface InfiniteGridMenuItem {
  image: string;
  link: string;
  title: string;
  description: string;
...
class InfiniteGridMenu {
  ...
  constructor(canvas: HTMLCanvasElement, items: InfiniteGridMenuItem[], onActiveItemChange?: (index: number) => void, onMovementChange?: (isMoving: boolean) => void, onInit?: ((menu: InfiniteGridMenu) => void) | null) {
    this.canvas = canvas;
    this.items = items || [];
...
const defaultItems: InfiniteGridMenuItem[] = [
  {
...
export default function InfiniteMenu({ items = [] }: { items?: InfiniteGridMenuItem[] }) {
  const canvasRef = useRef<HTMLCanvasElement>(null);
  const [activeItem, setActiveItem] = useState<InfiniteGridMenuItem | null>(null);
